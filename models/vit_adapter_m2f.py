...
class ViTAdapterM2F(nn.Module):
    ...
    def forward(self, x: torch.Tensor):
        ...
        """
        # Run entirely in float32 — BatchNorm2d in the encoder and deformable
        # attention in the pixel decoder both overflow in float16 AMP.
        with torch.autocast(device_type="cuda", enabled=False):
            ...
            # ViT-Adapter encoder → [f1(s4), f2(s8), f3(s16), f4(s32)]
